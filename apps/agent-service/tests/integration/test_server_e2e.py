...
HAS_MODEL_CREDENTIALS = bool(os.getenv("GOOGLE_API_KEY") or os.getenv("GOOGLE_CLOUD_PROJECT"))
...
@pytest.mark.skipif(not HAS_MODEL_CREDENTIALS, reason="LLM streaming test requires credentials.")

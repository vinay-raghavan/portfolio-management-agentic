...
- Provider checks: read-only provider catalog, provider health, configured import validation, sanitized provider profiles and import-job history, configured market/context imports, fixture market snapshots, and fixture universe members.
...
keeping job records free of resolved paths and raw provider payloads.

...
- Calls only policy-controlled console workflow endpoints for paper strategy drafts, simulated backtest requests, readiness-gated paper order proposals, human approval, simulated paper fills, and sanitized provider profile refreshes.

...
- The ADK agent exposes safe portfolio, briefing, provider, screener, pattern, factor-evidence, strategy-history, backtest-history, paper-ledger, and risk tools only.
